...
class VideoCaptureTransformer(VideoTransformerBase):
    ...
    def transform(self, frame):
        ...
        if time.time() - self.last_capture_time >= 1:
            ...
            cv2.imwrite('C:/Users/vx/Pictures/PY/captured_image.jpg', image)
            self.last_capture_time = time.time()

        # Preprocess the frame if required
        emotion_dict = {0: "angry", 1: "disgust", 2: "fear", 3: "happy", 4: "neutral", 5: "sad", 6: "surprise"}
        img = preprocess("C:/Users/vx/Pictures/PY/captured_image.jpg")

        # Load the model
        loaded_model = load_model("C:/Users/vx/Desktop/PYTHON/resnet50.h5")
